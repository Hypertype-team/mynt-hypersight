    ...
    <Layout>
      <div className="space-y-6">
        ...
        <p className="text-gray-600">
          Welcome Mathildajwonfewrfpbewropubpbjewgbjewrb, hope you're having a lovely day! Here is your HyperSight ticket analysis, tailored for you by Hypertype's AI tech 😊
        </p>
